...
export class Backend implements backendInterface {
    ...
    async createProject(arg0: string, arg1: Array<TextSegment>, arg2: StyleSettings): Promise<void> {
    ...
    async getProject(arg0: string): Promise<AnimationProject> {
        if (this.processError) {
            try {
    ...
    async updateProject(arg0: string, arg1: Array<TextSegment>, arg2: StyleSettings): Promise<void> {
        if (this.processError) {
            try {
